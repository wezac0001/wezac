...
module.exports = {
    ...
    SESSION: process.env.WEZAC_SESSION === undefined ? '' : process.env.WEZAC_SESSION,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'WezaC' : process.env.OWNER_NAME,
    ...
    GROUPN1: process.env.GROUP_NAME_1 === undefined ? 'WezaC OFFICIAL SUPPORT': process.env.GROUP_NAME_1,
    GROUPL1: process.env.GROUP_LINK_1 === undefined ? 'https://chat.whatsapp.com/GT5V8RakkftB7DAKWMeQML': process.env.GROUP_LINK_1,
    GROUPN2: process.env.GROUP_NAME_2 === undefined ? 'WezaC OFFICIAL TEST': process.env.GROUP_NAME_2,
    ...
    CAPTION: process.env.CAPTION === undefined ? ' ❰🍁🔱  WezaC Bot  🔱🍁❱ ' : process.env.CAPTION,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'WezaC' : process.env.BOT_NAME,
    ...
    FULLREX: process.env.FULL_ZAC === undefined ? 'false' : process.env.FULL_ZAC,
    ...
    TREX: process.env.WEZAC === undefined ? 'WezaC' : process.env.WEZAC,
    ...
    KTB: process.env.TAG_HEADER === undefined ? 'WezaC' : process.env.TAG_HEADER,
